...
impl Serializer {
    ...
    pub fn deserialize<'a, D: Deserialize<'a>>(
        data: &'a [u8],
    ) -> Result<D, rmp_serde::decode::Error> {
...
mod tests {
    ...
    fn serialize_deserialize_cpu_metrics_test() {
        ...
        let cpu_metrics_deserialized =
            Serializer::deserialize::<CpuStats>(&cpu_metrics_serialized).unwrap();
